...
class ArbiterEngine:
    ...
    def _build_arbiter_prompt(self) -> str:
        ...
        return (
            ...
            "- If NPC has 'grudge' or negative disposition: Lower success chance for charm\n"
            "- If NPC has 'knows_secret' tag: Success on investigate/charm should reveal it\n"
            ...
            "- 'charm' intent with [knows_secret] tag → success: True, narrative_seed: 'The janitor leans in and whispers about the sewers'\n"
            "- 'charm' intent with [has_it_out_for_me] tag → success: False, narrative_seed: 'The bartender scowls and ignores you'\n\n"
            "CRITICAL: Even simple social actions should have success: True (unless tags prevent it).\n"
