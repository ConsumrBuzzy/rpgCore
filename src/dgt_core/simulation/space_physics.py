...
Replaces grid-based movement with vector-based inertia and PID-controlled navigation
Supports automated target locking, orbital mechanics, and kinetic combat
"""
