...
namespace rpgCore.Godot.Rendering
{
    ...
    /// </summary>
    public class GameEntityRenderer : CanvasItem
    {
    ...
    /// </summary>
    public class SpaceEntityRenderer : EntityRenderer
    {
    ...
    /// </summary>
    public class ShipRenderer : EntityRenderer
    {
        public override void Render(CanvasItem canvas, EntityDTO entity, Vector2 worldScale)
        {
            if (entity == null)
    ...
    /// </summary>
    public class AsteroidRenderer : EntityRenderer
    {
        public override void Render(CanvasItem canvas, EntityDTO entity, Vector2 worldScale)
        {
            if (entity == null)
